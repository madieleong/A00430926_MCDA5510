...
Item 2: 
There is one compilation error in the project fix it. (change data source)

Please Answer:
What was it?  How did you fix? (shipment: change servicetypes to servicetype)
...
( on layout.cshtml: typo fixed:shippments -> shipments)
...
(in Customer.cs, change 'first name' to 'customer name')
Item 5:
...
(EstDateShipValidate.cs -> result < 0)
